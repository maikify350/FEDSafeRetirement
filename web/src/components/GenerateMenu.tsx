...
/**
 * Generates vertical and horizontal navigation menus from a declarative data array.
 * Recursively renders MenuSection, SubMenu, and MenuItem components from the menu config.
 *
 * @module components/GenerateMenu
 */
