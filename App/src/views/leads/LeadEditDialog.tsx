...
export default function LeadEditDialog({ open, onClose, lead, onSaved }: Props) {
  ...
  return (
    ...
    >
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1.2fr', gap: 16, marginTop: 16, marginBottom: 8 }}>
        <CustomTextField
          fullWidth label='Personal Phone #'
          value={form.personal_phone} onChange={handleChange('personal_phone')}
          disabled={saving}
        />
        <CustomTextField
          fullWidth label='Alternate Phone #'
          value={form.alternate_phone} onChange={handleChange('alternate_phone')}
          disabled={saving}
        />
        <CustomTextField
          fullWidth label='Personal Email'
