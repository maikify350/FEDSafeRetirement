 ...
 * Copilot extension. Queries fegli_rates_employee directly via Supabase
 * admin client, then runs the FEGLI engine.
 *
 * A future /api/proxy/calculateretirement endpoint will use the routines
 * in cowboy_pdf_preparer_api.js and fegli_api.js for retirement scenarios.
 *
