...
async function sendOfficialInvite() {
  console.log('Connecting to Google Workspace SMTP for contact@fedsaferetirement.com...')
  const transporter = nodemailer.createTransport({
    host: 'smtp.gmail.com',
    port: 465,
    secure: true,
    auth: {
      user: 'contact@fedsaferetirement.com',
      pass: 'qtjpgmrwiffilnlc',
    },
  })
  ...
  const actionLink = 'https://gqarlkfmpgaotbezpkbs.supabase.co/auth/v1/verify?token=9d4947c994640df1bf1838db4e675c7d54739be410fc70c667f5c3fa&type=recovery&redirect_to=https://fedsafe-retirement.vercel.app/auth/callback?next=/dashboard'
  const loginUrl = 'https://fedsafe-retirement.vercel.app/login'
  const recipientName = 'Mike Zaino'
  const to = 'mike@fedsaferetirement.com'
          ...
          <tr>
            <td style="padding:36px;">
              ...
              <p style="font-size:15px;line-height:1.6;color:#94a3b8;margin-bottom:24px;">
                You have been invited to the <strong>FEDSafe Retirement Portal</strong> as an authorized <strong>Partner</strong>. Your account gives you full access to the Federal Employee Prospecting CRM, Video Producer Studio, and FEGLI benefit calculators.
              </p>
                ...
                <tr>
                  <td style="padding:20px;">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        <td style="font-size:15px;font-weight:600;color:#ffffff;padding-bottom:14px;">
                          ${to}
                        </td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td style="font-size:16px;font-weight:700;font-family:monospace;color:#38bdf8;">
                          FedSafe2026!
                        </td>
                      </tr>
                    </table>
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-bottom:28px;">
                <tr>
                  <td align="center">
                    <a href="${actionLink}" target="_blank" style="display:inline-block;padding:14px 32px;background:linear-gradient(135deg, #6366f1 0%, #4f46e5 100%);color:#ffffff;text-decoration:none;font-weight:700;font-size:15px;border-radius:8px;box-shadow:0 4px 14px rgba(99,102,241,0.4);">
              ...
              <p style="font-size:13px;line-height:1.5;color:#64748b;margin-bottom:0;">
                You can also log in directly anytime at: <a href="${loginUrl}" style="color:#818cf8;">${loginUrl}</a>
              </p>
            </td>
          </tr>
...
`
  ...
  console.log(`Sending invitation email to ${to} from "FEDSafe Retirement" <contact@fedsaferetirement.com>...`)
  const info = await transporter.sendMail({
    from: '"FEDSafe Retirement" <contact@fedsaferetirement.com>',
    to,
  ...
  console.log('====================================================')
  console.log('🎉 INVITATION DISPATCHED SUCCESSFULLY!')
  console.log('Recipient:', to)
  console.log('Sender: "FEDSafe Retirement" <contact@fedsaferetirement.com>')
  console.log('Message ID:', info.messageId)
  console.log('====================================================')
}

sendOfficialInvite().catch(console.error)
