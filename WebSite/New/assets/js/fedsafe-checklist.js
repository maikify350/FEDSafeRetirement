(function () {
  ...
  if (!document.getElementById(styleId)) {
    ...
    s.textContent = [
      ...
      /* === Input overrides: !important to beat Salient body[data-form-style=minimal] resets in Edge === */
      '#fsr-checklist-form .fsr-cl-field input[type=text],#fsr-checklist-form .fsr-cl-field input[type=email],#fsr-checklist-form .fsr-cl-field input[type=tel],#fsr-checklist-form .fsr-cl-field textarea,#fsr-checklist-form .fsr-cl-field select{width:100%!important;padding:10px 13px!important;border:1px solid #d0d7e2!important;border-radius:8px!important;font-size:14px!important;font-family:inherit!important;background:#fff!important;color:#222!important;transition:border-color .2s,box-shadow .2s;box-sizing:border-box!important;height:auto!important;line-height:1.5!important;box-shadow:none!important}',
      '#fsr-checklist-form .fsr-cl-field input:focus,#fsr-checklist-form .fsr-cl-field textarea:focus,#fsr-checklist-form .fsr-cl-field select:focus{outline:none!important;border-color:#2d6fd4!important;box-shadow:0 0 0 3px rgba(45,111,212,.12)!important}',
      '#fsr-checklist-form .fsr-cl-field textarea{resize:vertical;min-height:88px}',
      '.fsr-cl-checkgroup{display:flex;flex-wrap:wrap;gap:10px;margin-top:4px}',
      '.fsr-cl-checkgroup label{display:flex!important;align-items:center;gap:8px;cursor:pointer;font-weight:400!important;font-size:14px!important;background:#f5f7fb;border:1px solid #d0d7e2!important;border-radius:8px!important;padding:8px 14px!important;transition:all .15s;user-select:none;color:#333!important;text-shadow:none!important;letter-spacing:0!important}',
      '.fsr-cl-checkgroup label:hover{border-color:#2d6fd4!important;background:#edf3ff!important}',
      '.fsr-cl-checkgroup input[type=checkbox]:checked+*,.fsr-cl-checkgroup label:has(input:checked){border-color:#2d6fd4!important;background:#edf3ff!important}',
      '.fsr-cl-checkgroup input[type=checkbox]{width:16px!important;height:16px!important;accent-color:#2d6fd4;margin:0!important;border-radius:3px!important}',
      /* Fallback for Edge versions that don't support :has() — JS will add .is-checked class */
      '.fsr-cl-checkgroup label.is-checked{border-color:#2d6fd4!important;background:#edf3ff!important}',
